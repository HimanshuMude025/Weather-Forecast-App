...
const GetWeather =  (city) =>{
    ...
    .catch((err)=>{
        ...
        ErrorMsg.style.opacity = 1;
        ErrorMsg.style.backgroundColor ="red";
        ErrorMsg.innerHTML =`${city} not found, ${err}`;
        SearchCity.focus();
        SearchCity.value = "";
        HideErrorMsg();
    })
...
const ShowWeather = (WeatherData) =>{
    // console.log(WeatherData.name, WeatherData.main.temp, WeatherData.weather[0].main, WeatherData.main.humidity, WeatherData.wind.speed);
    ...
    ConditionIconBox.innerHTML =`<img src="https:${WeatherData.current.condition.icon}" alt="Condition-Icon">`
    ...
    <img src="http:${WeatherData.forecast.forecastday[1].day.condition.icon}" alt="Condition-Icon">`
